      ...
      body: ListView(
        ...
        children: [
          ...
          TextFieldWidget(
              ...
              // onChanged: (name) {},
              onChanged: (name) async{user = widget.user.copyWith(name: name); print(user.name);}//Create copy of the user object in the UserData class
          ...
          TextFieldWidget(
              ...
              onChanged: (about) async {user = widget.user.copyWith(about: about); print(user.about);}
          ...
          OutlinedButton(
            onPressed: () async {
              ...
              print("OutlinedButton  user.name" + user.name);
              print("OutlinedButton  user.about" + user.about.toString());
              print("OutlinedButton Calling _updateUsers(user);");
